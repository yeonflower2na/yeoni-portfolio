...
function handleScrollDown() {
  if (currentPage === 0) {
    ...
    scrollCount++;
    console.log("Scroll Count (Down):", scrollCount);
    ...
    scrollCount++;
    console.log("Scroll to Footer Count:", scrollCount);
...
function handleScrollUp() {
  if (atFooter) {
    scrollCount++; 
    console.log("Footer Scroll Up Count:", scrollCount);
  ...
  if (currentPage === 2) {
    ...
    if (scrollCount > 0) {
      scrollCount--;
      console.log("Scroll Count (Up):", scrollCount);
    }
    if (scrollCount === 0) {
      // page2 -> page1
      smoothScrollTo(rightScroll, rightScroll.scrollTop - window.innerHeight, 700, () => {
